...
uses
  ...
  Winapi.Windows,
  {$ENDIF}
  SQLite3, System.Classes, System.SysUtils;
...
{$ENDIF}
  ...
  private
    ...
    function GetTypes(I: integer): String;
  ...
  public
    ...
    function FieldAsBlobBytes(I: cardinal): TBytesStream;
...
{$ENDIF}
    ...
    {: Return field name of some field.}
    property Columns[I: integer]: String read GetColumns;
    {: Return field type of some field.}
    property Types[I: integer]: String read GetTypes;
...
begin
  ...
  try
    ...
    begin
      Value.Add(String(Table.FieldAsString(0)));
      table.Next;
    end;
  finally
    Table.Free;
...
begin
  ...
  begin
    ...
    fTypes.Add(AnsiUpperCase(String(UTF8String(SQLite3_ColumnDeclType(fstmt, i)))));
  end;
...
function TSQLiteTable.FieldAsBlobBytes(I: cardinal): TBytesStream;
var
  iNumBytes: integer;
  ptr: pointer;
begin
...
function TSQLiteTable.GetTypes(I: integer): String;
begin
  Result := fTypes[I];
end;
...
begin
  Result := string(GetFields(self.GetFieldIndex(FieldName)));
end;
