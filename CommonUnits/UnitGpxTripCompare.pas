...
begin
  ...
  begin
    ...
    begin
      ...
      if (AnUdbDir.SubClass.IsKnownRoutePoint) then
        Inc(UdbDirCount);
    end;
    Inc(UdbHandleCount);
  end;
...
begin
  ...
  begin
    ...
    begin
      if (LocAnUdbDir.SubClass.IsKnownRoutePoint) then
      begin
        Messages.Add('');
  ...
  try
    ...
    begin
      ...
      begin
        ...
        if (FUdbDir.SubClass.IsKnownStartEndSegment) then
          continue;
        ...
        if (FUdbDir.SubClass.IsKnownRoutePoint) then
        begin
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            if (ToUdbDir.SubClass.IsKnownRoutePoint) then
              break;
          end;
          Inc(ToUdbHandleCnt);
        end;
