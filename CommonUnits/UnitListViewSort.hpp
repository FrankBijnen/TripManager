...
// (DO NOT EDIT: machine generated header) 'UnitListViewSort.pas' rev: 36.00 (Windows)

#ifndef UnitListViewSortHPP
#define UnitListViewSortHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_UNITLISTVIEWSORT)
using namespace Unitlistviewsort;
#endif
#pragma pack(pop)
#pragma option pop
